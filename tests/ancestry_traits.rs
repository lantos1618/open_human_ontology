...
use human_biology::biology::genetics::dermatology::{FitzpatrickType, HairColor};
...
fn test_east_asian_epicanthic_fold() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_EA_FOLD".to_string(), 25, BiologicalSex::Female);
...
fn test_african_keloid_susceptibility() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_AFR_KELOID".to_string(), 30, BiologicalSex::Male);
    ...
    assert!(
        skin.fitzpatrick_type == FitzpatrickType::TypeV
            || skin.fitzpatrick_type == FitzpatrickType::TypeVI
    );
}
...
fn test_european_lactose_persistence() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_EUR_LACTOSE".to_string(), 28, BiologicalSex::Female);
    ...
    if let Some(ancestry_profile) = &profile.genetics.ancestry {
        let eur_percentage = ancestry_profile
            .components()
            .get(&AncestryPopulation::European);
...
fn test_east_asian_alcohol_metabolism() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_EA_ALDH2".to_string(), 26, BiologicalSex::Male);
    ...
    let ea_percentage = ancestry_profile
        .components()
        .get(&AncestryPopulation::EastAsian)
        .unwrap();
...
fn test_south_asian_type2_diabetes_risk() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_SA_T2D".to_string(), 35, BiologicalSex::Female);
...
fn test_admixed_american_ancestry() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_ADMIX_AMR".to_string(), 30, BiologicalSex::Male);
...
fn test_ashkenazi_jewish_genetic_founder_effects() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_AJ_FOUNDER".to_string(), 32, BiologicalSex::Female);
...
fn test_neanderthal_denisovan_admixture() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_ARCHAIC".to_string(), 28, BiologicalSex::Male);
...
fn test_melanesian_high_denisovan() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_MELANESIAN".to_string(), 27, BiologicalSex::Male);
...
fn test_hair_texture_ancestry_correlation() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_HAIR_TEXTURE".to_string(), 24, BiologicalSex::Female);
    ...
    assert!(matches!(
        hair.predicted_color,
        HairColor::Black | HairColor::DarkBrown
    ));
}
...
fn test_red_hair_celtic_ancestry() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_RED_HAIR".to_string(), 29, BiologicalSex::Male);
...
fn test_high_altitude_adaptation() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_HIGH_ALT".to_string(), 26, BiologicalSex::Female);
...
fn test_northern_european_vitamin_d_synthesis() {
    let mut profile =
        ComprehensiveHealthProfile::new("TEST_VIT_D".to_string(), 31, BiologicalSex::Male);
    ...
    let skin = profile.genetics.skin_genetics.as_ref().unwrap();
    assert!(matches!(
        skin.fitzpatrick_type,
        FitzpatrickType::TypeI | FitzpatrickType::TypeII | FitzpatrickType::TypeIII
    ));
}
