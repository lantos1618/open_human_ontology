...
impl MetabolicDiseaseGenesCatalog {
    pub fn get_diabetes_genes() -> HashMap<String, GeneInfo> {
        ...
        genes.insert("TCF7L2".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Glucose homeostasis".to_string(), "Insulin secretion".to_string()],
            drug_interactions: vec!["Metformin".to_string()],
        });

        genes.insert("PPARG".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Adipocyte differentiation".to_string(), "Insulin sensitivity".to_string()],
            drug_interactions: vec!["Pioglitazone".to_string(), "Rosiglitazone".to_string()],
        });

        genes.insert("KCNJ11".to_string(), GeneInfo {
            symbol: "KCNJ11".to_string(),
            full_name: "Potassium Inwardly Rectifying Channel Subfamily J Member 11".to_string(),
            ...
            phenotypes: vec!["Insulin secretion".to_string(), "Pancreatic beta cell function".to_string()],
            drug_interactions: vec!["Sulfonylureas".to_string()],
        });

        genes.insert("SLC30A8".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Zinc transport in beta cells".to_string(), "Insulin processing".to_string()],
    ...
    pub fn get_obesity_genes() -> HashMap<String, GeneInfo> {
        ...
        genes.insert("FTO".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Energy homeostasis".to_string(), "Appetite regulation".to_string()],
            drug_interactions: vec![],
        });

        genes.insert("MC4R".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Satiety regulation".to_string(), "Energy expenditure".to_string()],
            drug_interactions: vec!["Setmelanotide".to_string()],
        });

        genes.insert("LEP".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Appetite regulation".to_string(), "Energy balance".to_string()],
    ...
    pub fn get_lipid_metabolism_genes() -> HashMap<String, GeneInfo> {
        ...
        genes.insert("LDLR".to_string(), GeneInfo {
        ...
        genes.insert("PCSK9".to_string(), GeneInfo {
        ...
        genes.insert("APOB".to_string(), GeneInfo {
            ...
            phenotypes: vec!["LDL particle structure".to_string(), "Lipid transport".to_string()],
    ...
    pub fn get_thyroid_genes() -> HashMap<String, GeneInfo> {
        ...
        genes.insert("THRB".to_string(), GeneInfo {
        ...
        genes.insert("DUOX2".to_string(), GeneInfo {
            ...
            phenotypes: vec!["Thyroid hormone synthesis".to_string(), "Hydrogen peroxide generation".to_string()],
            drug_interactions: vec!["Levothyroxine".to_string()],
        });
